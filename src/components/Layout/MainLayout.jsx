/* eslint-disable max-lines, max-len, max-statements, max-lines-per-function, max-nested-callbacks */
...
const SideNavigation = () => {
    ...
    const navigation = [
        { icon: HomeIcon, name: 'Dashboard', to: '.' },
        { icon: FolderIcon, name: 'Discussions', to: './discussions' },
